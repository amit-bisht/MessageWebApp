  ...
  return (
    <>
      <div className="channel-panel flex flex-col items-stretch justify-start  w-[100%] max-w-[320px] h-[100%] z-[3]">
        ...
        <div className="channel-filter p-[0.8rem]" style={{backgroundColor:'white',borderRadius:'2px',boxShadow:'0 0 5px rgba(0, 0, 0, 0.2)'}}>
          <input
            className="indent-[10px] w-[100%] h-[100%]   focus:outline-none"
            placeholder={`Search ${
              isAddingUser
                ? "User"
                : !isAddingUser && msgType === "User"
        ...
        <div style={{backgroundColor:"#f0f0f0"}} className="theme-picker mt-auto p-[0.8rem] min-h-[70px] w-[100%] flex flex-row justify-center items-center gap-[1rem]">
          {/* {Dark Theme} */}
